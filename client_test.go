...
func TestAutoResume(t *testing.T) {
	...
	t.Run("WithNoContentLengthHeaderAndChecksumFailure", func(t *testing.T) {
		// ref: https://github.com/isi-lincoln/grab/pull/27
		size := size * 2
		grabtest.WithTestServer(t, func(url string) {
			req := mustNewRequest(filename, url)
			req.SetChecksum(sha256.New(), sum, false)
...
func TestIssue37(t *testing.T) {
	// ref: https://github.com/isi-lincoln/grab/issues/37
...
//
// Fixes: https://github.com/isi-lincoln/grab/issues/43
...
// a solution to this issue. Ref: https://github.com/isi-lincoln/grab/pull/27
